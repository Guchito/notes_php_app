    ...
    <div class="mx-auto max-w-1/2 px-4 py-6 sm:px-6 lg:px-8 flex flex-col items-center">
      <div class="w-1/2 bg-white rounded-lg shadow p-6">
        ...
        <div class="mb-4">
          ...
          <textarea id="body" name="body" rows="4" required class="mt-1 block w-full bg-gray-100 border-gray-600 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="What's on your mind?"><?= $_POST['body'] ?? '' ?> </textarea>
